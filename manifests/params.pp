...
class puppet::params {
  ...
  $legacy_auth_template   = 'puppet/auth.conf.erb'
  ...
  $server_metrics_conf_template      = 'puppet/server/puppetserver/conf.d/metrics.conf.erb'
  $server_product_conf_template      = 'puppet/server/puppetserver/conf.d/product.conf.erb'
  $server_puppetserver_conf_template = 'puppet/server/puppetserver/conf.d/puppetserver.conf.erb'
  $server_webserver_conf_template    = 'puppet/server/puppetserver/conf.d/webserver.conf.erb'
